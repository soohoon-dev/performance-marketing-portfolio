...
| Area              | Document                                                                           | Type                   | Notes                                                   |
| ----------------- | ---------------------------------------------------------------------------------- | ---------------------- | ------------------------------------------------------- |
| **Data Strategy** | **[Zero-Budget Growth Strategy (Skincare)](./skincare-growth-strategy/README.md)** | **End-to-End Project** | **Python ETL, BigQuery, Looker Studio, CRM Automation** |
| Framework         | Execution Framework (Ask → Act)                                                    | External repo          | https://github.com/soohoon-dev/book-execution-framework |
| Automotive        | Media Ops Playbook (Anonymous)                                                     | Playbook               | targeting, QA, exclusions, reporting routines           |
